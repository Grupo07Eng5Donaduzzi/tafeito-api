...
--> statement-breakpoint
DO $$ BEGIN
  ALTER TABLE "budget_requests" ADD COLUMN "title" text NOT NULL;
EXCEPTION WHEN duplicate_column THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
  ALTER TABLE "budget_requests" ADD COLUMN "category" text NOT NULL;
EXCEPTION WHEN duplicate_column THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
  ALTER TABLE "budget_requests" ADD COLUMN "location" text NOT NULL;
EXCEPTION WHEN duplicate_column THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
