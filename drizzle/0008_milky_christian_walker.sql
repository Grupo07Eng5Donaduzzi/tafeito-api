...
--> statement-breakpoint
ALTER TABLE "budget_requests" ADD COLUMN IF NOT EXISTS "title" text NOT NULL DEFAULT '';
--> statement-breakpoint
ALTER TABLE "budget_requests" ADD COLUMN IF NOT EXISTS "category" text NOT NULL DEFAULT '';
--> statement-breakpoint
ALTER TABLE "budget_requests" ADD COLUMN IF NOT EXISTS "location" text NOT NULL DEFAULT '';
--> statement-breakpoint
ALTER TABLE "budget_requests" ADD COLUMN IF NOT EXISTS "cancellation_reason" text;
--> statement-breakpoint
...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "conversations_service_id_idx" ON "conversations" USING btree ("service_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "conversations_proposal_id_idx" ON "conversations" USING btree ("proposal_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "messages_service_id_idx" ON "messages" USING btree ("service_id");
--> statement-breakpoint
