...
--> statement-breakpoint
ALTER TABLE "budget_requests" ADD COLUMN "title" text NOT NULL;--> statement-breakpoint
ALTER TABLE "budget_requests" ADD COLUMN "category" text NOT NULL;--> statement-breakpoint
ALTER TABLE "budget_requests" ADD COLUMN "location" text NOT NULL;--> statement-breakpoint
